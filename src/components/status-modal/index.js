...
export function initStatusModal(state) {
  ...
  document.querySelector('#statusBackdrop').addEventListener('click', closeStatusModal);
  document.querySelector('#btnLanded').addEventListener('click', () => applyStatus(state, 'landed'));
  document.querySelector('#btnMissed').addEventListener('click', () => applyStatus(state, 'missed'));
  document.querySelector('#btnSkip').addEventListener('click', () => applyStatus(state, 'skipped'));
}
